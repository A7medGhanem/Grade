...
class Galant extends StatefulWidget {
  const Galant({super.key});

  @override
  State<Galant> createState() => _GalantState();
}

class _GalantState extends State<Galant> {
  CollectionReference user = FirebaseFirestore.instance.collection("Galant");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('ميتسوبيشي جالانت 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
