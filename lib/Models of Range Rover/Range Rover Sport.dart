...
class Range_Rover_Sport extends StatelessWidget {
  const Range_Rover_Sport({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference user = FirebaseFirestore.instance.collection("Range Rover Sport");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text(' رانج روڤر اسبورت 2023 ',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
