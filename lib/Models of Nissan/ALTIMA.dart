...
class ALTIMA extends StatefulWidget {
  const ALTIMA({super.key});

  @override
  State<ALTIMA> createState() => _ALTIMAState();
}

class _ALTIMAState extends State<ALTIMA> {
  CollectionReference user = FirebaseFirestore.instance.collection("ALTIMA");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('نيسان صني 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
