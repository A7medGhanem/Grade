...
class Haval_H4 extends StatelessWidget {
  const Haval_H4({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference user = FirebaseFirestore.instance.collection("Haval H4");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('هافال اتش 4 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
