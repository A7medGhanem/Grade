...
class Avlon extends StatefulWidget {
  const Avlon({super.key});

  @override
  State<Avlon> createState() => _AvlonState();
}

class _AvlonState extends State<Avlon> {
  CollectionReference user = FirebaseFirestore.instance.collection("Avalon");
  @override
