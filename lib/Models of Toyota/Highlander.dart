...
class _HighlanderState extends State<Highlander> {
  CollectionReference user = FirebaseFirestore.instance.collection("Highlander");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('تيوتا هاي لاندر 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
