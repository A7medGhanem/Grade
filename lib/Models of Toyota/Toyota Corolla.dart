...
class Toyota_Corolla extends StatefulWidget {
  const Toyota_Corolla({super.key});

  @override
  State<Toyota_Corolla> createState() => _Toyota_CorollaState();
}

class _Toyota_CorollaState extends State<Toyota_Corolla> {
  CollectionReference user = FirebaseFirestore.instance.collection("Toyota Corolla");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('تيوتا لاند كروزر 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
