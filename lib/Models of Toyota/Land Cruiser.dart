...
class Land_Cruiser extends StatefulWidget {
  const Land_Cruiser({super.key});

  @override
  State<Land_Cruiser> createState() => _Land_CruiserState();
}

class _Land_CruiserState extends State<Land_Cruiser> {
  CollectionReference user = FirebaseFirestore.instance.collection("Land Cruiser");
  @override
