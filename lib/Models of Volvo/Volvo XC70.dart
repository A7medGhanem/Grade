...
class Volvo_XC70 extends StatelessWidget {
  const Volvo_XC70({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference user = FirebaseFirestore.instance.collection("Volvo XC70");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('فولفو اكس سي 70 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
