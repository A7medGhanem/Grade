...
class Mini_Paceman extends StatefulWidget {
  const Mini_Paceman({super.key});

  @override
  State<Mini_Paceman> createState() => _Mini_PacemanState();
}

class _Mini_PacemanState extends State<Mini_Paceman> {
  CollectionReference user = FirebaseFirestore.instance.collection("Mini Paceman");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('ميني بيسمان 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
