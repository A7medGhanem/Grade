...
class CHEVROLET_TRAVERSE extends StatelessWidget {
  const CHEVROLET_TRAVERSE({super.key});
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('شيفروليه ترافيس 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
