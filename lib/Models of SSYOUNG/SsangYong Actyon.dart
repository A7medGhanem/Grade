...
class SsangYong_Actyon extends StatelessWidget {
  const SsangYong_Actyon({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference user = FirebaseFirestore.instance.collection("SsangYong Actyon");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text(' سانج يانج اكتيون 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
