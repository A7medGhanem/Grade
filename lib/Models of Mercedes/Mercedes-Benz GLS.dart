...
class Mercedes_GLS extends StatefulWidget {
  const Mercedes_GLS({super.key});

  @override
  State<Mercedes_GLS> createState() => _Mercedes_GLSState();
}

class _Mercedes_GLSState extends State<Mercedes_GLS> {
  CollectionReference user = FirebaseFirestore.instance.collection("Mercedes-Benz GLS");
  @override
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('مرسيدس جي ال اس 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
