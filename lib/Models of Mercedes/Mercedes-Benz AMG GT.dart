...
class Mercedes_Benz extends StatefulWidget {
  const Mercedes_Benz({super.key});

  @override
  State<Mercedes_Benz> createState() => _Mercedes_BenzState();
}

class _Mercedes_BenzState extends State<Mercedes_Benz> {
  CollectionReference user = FirebaseFirestore.instance.collection("Mercedes-Benz AMG GT");
  @override
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('AMG GT بينز 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
