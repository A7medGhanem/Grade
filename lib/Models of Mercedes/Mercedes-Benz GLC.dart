...
class Mercedes_BenzGlc extends StatefulWidget {
  const Mercedes_BenzGlc({super.key});

  @override
  State<Mercedes_BenzGlc> createState() => _Mercedes_BenzState();
}

class _Mercedes_BenzState extends State<Mercedes_BenzGlc> {
  CollectionReference user = FirebaseFirestore.instance.collection("Mercedes-Benz GLC");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text(' بينز جي ال سي 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
