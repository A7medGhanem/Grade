...
class Mercedes_EClass extends StatefulWidget {
  const Mercedes_EClass({super.key});

  @override
  State<Mercedes_EClass> createState() => _Mercedes_EClassState();
}

class _Mercedes_EClassState extends State<Mercedes_EClass> {
  CollectionReference user = FirebaseFirestore.instance.collection("Mercedes-Benz E-Class");
  @override
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('E بينز كلاس 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
