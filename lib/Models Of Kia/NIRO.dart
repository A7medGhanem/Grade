...
class NIRO extends StatelessWidget {
  const NIRO({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference user = FirebaseFirestore.instance.collection("NIRO");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('كيا نيرو 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
