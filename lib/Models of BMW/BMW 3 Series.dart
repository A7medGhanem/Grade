...
class BMW3 extends StatefulWidget {
  const BMW3({super.key});

  @override
  State<BMW3> createState() => _BMW3State();
}

class _BMW3State extends State<BMW3> {
  CollectionReference user = FirebaseFirestore.instance.collection("BMW 3 Series");
  @override
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text(' الفئة الثالثة 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
