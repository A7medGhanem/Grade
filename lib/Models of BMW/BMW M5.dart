...
class BMW_M5 extends StatefulWidget {
  const BMW_M5({super.key});

  @override
  State<BMW_M5> createState() => _BMW_M5State();
}

class _BMW_M5State extends State<BMW_M5> {
  CollectionReference user = FirebaseFirestore.instance.collection("BMW M5");
  @override
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('  ام دبليو ام 5 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
