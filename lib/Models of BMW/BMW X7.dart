...
class BMW_X7 extends StatefulWidget {
  const BMW_X7({super.key});

  @override
  State<BMW_X7> createState() => _BMW_X7State();
}

class _BMW_X7State extends State<BMW_X7> {
  CollectionReference user = FirebaseFirestore.instance.collection("BMW X7");
  @override
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text(' ام دبليو اكس7 2023',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
